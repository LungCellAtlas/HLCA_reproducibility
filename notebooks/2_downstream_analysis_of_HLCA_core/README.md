### Modeling effects of bilogical covariates (age, sex, BMI, anatomical location, etc.) on cell-type specific gene expression, and GWAS analysis linking lung disease-related genomic variants to lung cell types.
